...
VALUES('rsvp-browser','rsvp-browser','rsvp-browser','RSVP browser gathering','Test Venue','Accra','${start}','${end}','Night',10000,25,'18+','Test DJ','/events/the-weekend-braai.jpeg','A complete private browser fixture for RSVP registration.','published','${stamp}','${stamp}',0,'confirmed','on_sale');
