...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "/",
    images: [{ url: "/social-card.png?v=5", width: 1200, height: 630, alt: "BeCore Tickets — Accra's edited night out" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "BeCore Tickets — Accra's party shortlist",
    description: "Give the group chat an actual plan. Accra parties, MoMo or card tickets and a private Room for the people going.",
    images: ["/social-card.png?v=5"],
  },
  ...
  icons: {
    icon: [
      ...
      { url: "/favicon-64x64.png?v=5", sizes: "64x64", type: "image/png" },
    ],
