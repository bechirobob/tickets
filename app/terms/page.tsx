...
export default function TermsPage() {
  return <main className="policy-page">
    <header><Link href="/" aria-label="Back home"><ArrowLeft size={15} /><span className="support-back-label">Back home</span></Link><Link href="/" className="night-brand-link"><BrandLogo /></Link><PublicNavigation /></header>
