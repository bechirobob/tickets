...
const guides: Guide[] = [
  ...
  },
  {
    ...
    summary: "Room updates start on for ticket holders, with one bell controlling that Night.",
    steps: ["Open the Night. A filled bell means Room notifications are on by default.", "Tap the bell to turn that Night off or back on—there is no notification menu to work through.", "For lock-screen alerts, your first bell tap may ask for your browser or device permission. You can refuse it and still use the in-app Room."],
    action: { href: "/my-nights", label: "Open My Nights" },
  },
  {
    id: "room-flashes",
