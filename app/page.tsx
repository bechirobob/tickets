    ...
    <div className="room-product-phone__screen">
      ...
      <div className="room-product-phone__stream">
        {conversation === "arrival" ? <>
          ...
          <article className="scene-message"><span>AM</span><div className="scene-message__body"><small className="scene-message__meta">Ama <b className="scene-vip-badge" aria-label="VIP ticket holder" title="VIP ticket holder"><Gem size={10} aria-hidden="true" /></b> · 10:42 PM</small><div className="scene-message__bubble"><p>Front left is the move tonight.</p></div><div className="scene-message__reactions" aria-label="6 watching reactions"><i>👀</i><b>6</b></div></div></article>
