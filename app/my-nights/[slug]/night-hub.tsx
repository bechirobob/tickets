...
type Experience = { attendee: { displayName: string }; preference: { attendeeVisible: boolean; keepPosted: boolean }; questions: Question[]; updates: Update[]; memories: Array<{ id: string; title: string; body: string; imageUrl: string | null; publishedAt: string; publishedBy: string }>; visibleAttendees: number };
...
type TicketOrder = {
  ...
  currency: string; paidAt: string | null; bookedFor: string | null; canViewPurchase: boolean; tierName: string | null; tierDescription: string | null; roomBadge: "VIP" | null; tickets: GateTicket[];
};
