...
type EventRecord = { slug: string; title: string; venue: string; venueMapUrl: string; area: string; startsAt: string; endsAt: string; vibe: string; salesOpenAt: string | null; salesCloseAt: string | null; ageRestriction: string; lineup: string; eventState: string; isTestEvent: boolean; rescheduledFrom: string | null; curationNote: string; dressCode?: string | null; colourScheme?: string | null; awarenessNote?: string | null; guestPerk?: string | null; status: string; tiers: Tier[] };
