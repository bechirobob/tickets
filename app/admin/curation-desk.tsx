  ...
  return (
    <main className="curation-page">
      <aside className="curation-nav">
        ...
        <nav><span>Curation</span><Link className="active" href="/admin">Submission queue</Link><Link href="/admin/fees">Fees & charges</Link><Link href="/organizer">Organiser view</Link></nav>
