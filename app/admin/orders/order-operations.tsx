...
type Order = { id: string; reference: string; eventSlug: string; eventTitle: string; ticketType: string; unitQuantity: number; quantity: number; totalAmountMinor: number; refundedAmountMinor: number; currency: string; customerEmail: string; customerPhone: string; customerName: string | null; status: string; paymentProvider: "paystack" | "seevplus"; providerStatus: string | null; providerReference: string | null; paymentEnvironment: string | null; failureReason: string | null; refundStatus: string | null; disputeStatus: string | null; createdAt: string; paidAt: string | null; checkedInCount: number };
