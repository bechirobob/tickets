...
BEGIN
  ...
  UPDATE apple_wallet_passes SET update_tag=(SELECT value FROM apple_wallet_update_clock WHERE id=1),updated_at=strftime('%Y-%m-%dT%H:%M:%fZ','now') WHERE event_slug=NEW.slug;
END;
--> statement-breakpoint
...
BEGIN
  ...
  UPDATE apple_wallet_passes SET update_tag=(SELECT value FROM apple_wallet_update_clock WHERE id=1),updated_at=strftime('%Y-%m-%dT%H:%M:%fZ','now') WHERE ticket_id=NEW.id;
END;
--> statement-breakpoint
...
BEGIN
  ...
  UPDATE apple_wallet_passes SET update_tag=(SELECT value FROM apple_wallet_update_clock WHERE id=1),updated_at=strftime('%Y-%m-%dT%H:%M:%fZ','now') WHERE ticket_id=NEW.ticket_id AND attendee_id=OLD.attendee_id;
END;
--> statement-breakpoint
...
BEGIN
  ...
  UPDATE apple_wallet_passes SET update_tag=(SELECT value FROM apple_wallet_update_clock WHERE id=1),updated_at=strftime('%Y-%m-%dT%H:%M:%fZ','now') WHERE ticket_id=NEW.ticket_id AND attendee_id=NEW.attendee_id;
END;
--> statement-breakpoint
...
BEGIN
  ...
  UPDATE apple_wallet_passes SET update_tag=(SELECT value FROM apple_wallet_update_clock WHERE id=1),updated_at=strftime('%Y-%m-%dT%H:%M:%fZ','now') WHERE ticket_id=OLD.ticket_id AND attendee_id=OLD.attendee_id;
END;
--> statement-breakpoint
...
BEGIN
  ...
  UPDATE apple_wallet_passes SET update_tag=(SELECT value FROM apple_wallet_update_clock WHERE id=1),updated_at=strftime('%Y-%m-%dT%H:%M:%fZ','now') WHERE ticket_id=OLD.ticket_id;
END;