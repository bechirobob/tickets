...
export function safeReturnTo(value: string | null | undefined): string {
  ...
  if (value.startsWith("/admin") || value === "/scan" || value.startsWith("/organizer/workspace") || value.startsWith("/organizer/analytics") || value.startsWith("/organizer/assistant")) return value;
  return "/admin";
}
